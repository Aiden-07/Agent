...
function initCreateKbForm() {
    ...
    if (sliceStrategyEl) {
        sliceStrategyEl.onchange = function() {
    ...
    const sliceModeParent = document.getElementById('create-kb-slice-mode-parent');
    const sliceModeFull = document.getElementById('create-kb-slice-mode-full');
    if (sliceModeParent && sliceModeFull) {
        sliceModeParent.onclick = function() {
            setCreateKbSliceMode('parent');
        };
        sliceModeFull.onclick = function() {
            setCreateKbSliceMode('full');
        };
    }
